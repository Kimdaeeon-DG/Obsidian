...
###### 만약 피평가자가 Debian을 선택했을 경우 : [[aptitude]]와 [[apt]]를 설명하고 [[aptitude와 apt 사이의 차이점]] / [[APPArmer]]이란 무엇인가 / 디팬스 동안에 스크립트가 10분마다 정보를 출력해야한다 (이 동작은 나중에 평가 중에 더 자세히 체크하게 될 것입니다)
